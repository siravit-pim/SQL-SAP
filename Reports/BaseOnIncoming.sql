...
,isnull((select isnull(rct.Total,0) where rct.TypePay = '2' ),0) 'TotalVPM'
...
,oadm
where orct.Canceled = 'N' and orct.DocType = 'A' and orct.CardCode = '219-204' --and orct.DocEntry  =  4279 ) 
